...
import trimQLogo from "@/app/TrimQ.png";
...
export function WelcomeSplash() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-background/95 backdrop-blur-[2px]">
      <section className="flex h-full w-full flex-col items-center justify-center px-4 py-8 text-center sm:px-6">
        <Image
          src={trimQLogo}
          alt="TrimQ"
          priority
